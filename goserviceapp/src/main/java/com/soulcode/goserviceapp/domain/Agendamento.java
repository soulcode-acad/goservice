...
public class Agendamento {
    ...
    @NotNull(message= "O campo de agendamento referente ao cliente não pode estar vazio.")
    @ManyToOne
    @JoinColumn(nullable = false)
    private Cliente cliente;
    @NotNull(message= "O campo de agendamento referente ao Prestador não pode estar vazio.")
    @ManyToOne
    @JoinColumn(nullable = false)
    private Prestador prestador;
    @NotNull(message= "O campo de agendamento referente ao Serviço não pode estar vazio.")
    @ManyToOne
    @JoinColumn(nullable = false)
    private Servico servico;
    @NotNull(message= "O status de agendamento não pode estar vazio.")
    @Enumerated(EnumType.STRING)
    @Column(nullable = false)
    private StatusAgendamento statusAgendamento;
    @NotNull(message= "A data do agendamento nao pode estar vazia.")
    @Column(nullable = false)
    private LocalDate data;
    @NotNull(message= "A hora do agendamento nao pode estar vazia.")
    @Column(nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, agendamento.id) &&
                ...
                Objects.equals(hora, agendamento.hora) && Objects.equals(dataHoraRegistro, agendamento.dataHoraRegistro);
    }
