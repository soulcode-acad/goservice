...
public class Agendamento {
    ...
    public Agendamento(long id, Cliente cliente, Prestador prestador, Servico servico, StatusAgendamento statusAgendamento, LocalTime hora, LocalDateTime dataHoraRegistro, LocalDate data) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, agendamento.id) && Objects.equals(cliente, agendamento.cliente) && Objects.equals(prestador, agendamento.prestador) && Objects.equals(servico, agendamento.servico) && statusAgendamento == agendamento.statusAgendamento && Objects.equals(hora, agendamento.hora) && Objects.equals(dataHoraRegistro, agendamento.dataHoraRegistro) && Objects.equals(data, agendamento.data);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, cliente, prestador, servico, statusAgendamento, hora, dataHoraRegistro, data);
    }
}
