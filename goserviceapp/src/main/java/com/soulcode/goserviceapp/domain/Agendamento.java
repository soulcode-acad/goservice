...
public class Agendamento {
    ...
    @NotNull(message = "O status de agendamento não pode ser nulo")
    @Enumerated(EnumType.STRING)
    @Column(nullable = false)
    private StatusAgendamento statusAgendamento;

    @NotNull(message = "A data de agendamento não pode ser vazia")
    @Column(nullable = false)
    private LocalDate data;

    @NotNull(message = "A hora de agendamento não pode ser vazio")
    @Column(nullable = false)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, agendamento.id) && Objects.equals(cliente, agendamento.cliente) && Objects.equals(prestador, agendamento.prestador) && Objects.equals(servico, agendamento.servico) && statusAgendamento == agendamento.statusAgendamento && Objects.equals(data, agendamento.data) && Objects.equals(hora, agendamento.hora) && Objects.equals(dataHoraRegistro, agendamento.dataHoraRegistro);
    }
