...
public class AuthController {
    ...
    public ModelAndView login(@RequestParam(name = "error", required = false) String error) {
        ...
        if (error != null) {
            mv.addObject("error Message", "Erro ao autenticar no sistema. Verifique suas credenciais.");
        }
        return mv;
    }
    ...
    public String updatePassword(
        ...
        try {
            ...
            attributes.addFlashAttribute("errorMessage", "Erro ao tentar alterar senha.");
        }
